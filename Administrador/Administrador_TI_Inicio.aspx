<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administrador_TI_Inicio.aspx.cs" Inherits="Proyecto_Final_Diseño_.Administrador_TI_Inicio" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="barra-superior">
            <asp:Label ID="Label1" runat="server" CssClass="titulo" Text="Administrador TI"></asp:Label>
        </div>
        ...
        <div class="contenedor">
            ...
            <!-- Contenido -->
            <div class="contenido">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/imagenes/fotos/Adm_TI.png" />
